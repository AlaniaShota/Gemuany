    ...
    import { descriptionAboutPage, aboutTitle, aboutSectionTitle, aboutSectionDescription, readMoreBtn, visionTitle, visionDescription, setsTitle, meetTeamTitle, meetTeamDescription } from "./component/constanta";
    ...
    export default function About(){
        ...
        const styleSetsPosition = 'items-center'
        const fullBannerPosition = "absolute inset-0 flex flex-col justify-around items-start w-3/6 h-full z-50"
        const contentAboutSectionPosition = 'flex flex-col justify-around items-start w-4/6'
        ...
        return (
            <>
                ...
                <FullBanner 
                    ...
                    /> 
                <Review data={sets} title={setsTitle} position={styleSetsPosition}/>
                <FullBanner 
                    img={visionImg}
                    title={visionTitle} 
