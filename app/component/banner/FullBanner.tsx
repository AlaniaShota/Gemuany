...
const FullBanner:React.FC<BannerProps> = ({ animation, title, description, stylePosition, contentAboutSectionPosition, img}) => {
  ...
  return (
    <div className={`relative inset-0 flex h-full w-4/5 my-40 mx-auto`}>
        ...
        <motion.div
            ...
            className={`${stylePosition ? stylePosition : contentAboutSectionPosition} ml-10`}>
