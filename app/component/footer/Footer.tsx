...
const Footer = () => {
  return (
    <div className='flex flex-col justify-around items-start w-4/5 mx-auto mt-20'>
      <h1 className={`${lobster.className} text-redGemuany text-5xl`}>{titleGemuany}</h1>
      <LinkList/>
      <h2 className={`${montserrat.className} text-whiteSecond text-center w-full my-10 cursor-default`}>{inc}</h2>
    </div>
  )
}
